...
open class Acuario(open var largo: Int = 100, open var ancho: Int = 20, open var alto: Int = 40) {
    ...
    // Constructor secundario que toma número de peces
    constructor(numeroDePeces: Int) : this() {
        // 2,000 cm³ por pez + espacio extra para que no se derrame
        val tanque = numeroDePeces * 2000 * 1.1

        // Mantener largo y ancho, calcular altura necesaria
        alto = (tanque / (largo * ancho)).toInt()
    }

    // Propiedad volumen con getter y setter personalizados
    open var volumen: Int
        get() = ancho * alto * largo / 1000 // 1000 cm³ = 1 l
        set(valor) {
            alto = (valor * 1000) / (ancho * largo)
        }

    // Propiedades adicionales para herencia
